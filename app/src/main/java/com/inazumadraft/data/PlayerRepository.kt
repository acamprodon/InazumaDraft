...
object PlayerRepository {
    ...
    val players = listOf(
        ...
        Player("Axel Blaze", "Axel", "DL", R.drawable.fuego,90, 84, 85,65,  R.drawable.axel),
        Player("Jude Sharp", "Jude","MC",R.drawable.aire, 81, 82, 91,75,  R.drawable.jude),
        Player("Nathan Swift", "Nathan", "DF", R.drawable.aire, 79, 95, 75,73,  R.drawable.nathan, secondaryPositions = listOf("MC", "DL")),
        ...
        Player("Jack Wallside","Jack" ,"DF", R.drawable.earth, 62, 53, 72,85,  R.drawable.jack),
        ...
        Player("Caleb Stonewall", "Caleb", "MC", R.drawable.fuego,77, 83, 88, 79,R.drawable.caleb),
        Player("Archer Hawkins","Archer", "DF", R.drawable.bosque,83, 73, 62,78,  R.drawable.archer),
       ...
       Player("William Glass", "Willy","DL", R.drawable.bosque, 50 ,45, 43, 2, R.drawable.willy),
